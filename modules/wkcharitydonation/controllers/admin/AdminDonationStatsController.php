...
class AdminDonationStatsController extends ModuleAdminController
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->toolbar_title = $this->l('Donations stats');
    ...
    public function initDonationStats()
    {
        ...
        $this->toolbar_title = $this->l('Donation stats');
    ...
    public function renderKpis()
    {
        $objDonationInfo = new WkDonationInfo();
        $kpis = [];
        $totalDonationAmount = $objDonationInfo->getTotalDonationAmount();
        ...
        $helper->value = $totalDonationAmount ? WkDonationInfo::displayPrice($totalDonationAmount) : WkDonationInfo::displayPrice(0);
        $kpis[] = $helper->generate();
    ...
    public function renderView()
    {
        if ($idDonation = Tools::getValue('id_donation_info')) {
            ...
            if (isset($this->context->cookie->previous_shop_id) && $this->context->cookie->previous_shop_id != $currentShopID) {
                $this->context->cookie->previous_shop_id = $currentShopID;

                Tools::redirectAdmin($this->context->link->getAdminLink('AdminDonationStats'));
            }
    ...
    public function initDonationOrderList()
    {
        $this->status_array = [
            ...
            $this->l('Cancled') => $this->l('Cancelled'),
