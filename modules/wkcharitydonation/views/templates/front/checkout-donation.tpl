			...
			<div class="cart-grid-body col-xs-12 col-xl-7">
				...
				<div class="card cart-container">
					<div class="card-block">
						<h1 class="h1 mb-0">{l s='Shopping Cart' mod='wkcharitydonation'}</h1>
					</div>
					<hr class="separator">
					...
					<div class="card">
						...
						<div class="charity-block">
							{foreach $checkoutDonations as $checkoutDonation}
								...
								<form class="donation-block" method="POST" action="{$cart_url|escape:'html':'UTF-8'}">
									<div class="donation-text">
    									...
    									<div class="donation-note">
    									  <span>{l s='Note' mod='wkcharitydonation'}: </span>{l s='Minimum amount for this donation is' mod='wkcharitydonation'} {$checkoutDonation['displayPrice']|escape:'html':'UTF-8'}
    									</div>
    								{/if}
									</div>
									
                  
                  <div class="donation-group flex flex-col items-center justify-center gap-2">
									
  									<div class="donation-price-div">
  										<div class="row">
  											<div class="col-xs-12">
  												...
  												{else}
  													<div class="input-group">
  														<span class="input-group-addon wk_display_flex_center">{$currency_sign|escape:'html':'UTF-8'}</span>
