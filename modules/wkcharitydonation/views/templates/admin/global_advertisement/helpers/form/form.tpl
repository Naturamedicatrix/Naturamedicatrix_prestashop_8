            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="row">
                        <div class="col-sm-6">
                            <p>
                                <img src="{$imagePath_head_foot|escape:'html':'UTF-8'}?time={time()|escape:'html':'UTF-8'}" height="80px" width="600px" class="{if !$imagePath_head_foot}hidden{/if}">
                            </p>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="row">
                        <div class="col-sm-6">
                            <p>
                                <img src="{$imagePath_left_right|escape:'html':'UTF-8'}?time={time()|escape:'html':'UTF-8'}" height="200px" width="160px" class="{if !$imagePath_left_right}hidden{/if}">
                            </p>
