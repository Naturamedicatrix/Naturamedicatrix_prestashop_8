    ...
    <div class="panel">
        <div class="panel-heading">
            ...
            {if isset($donationInfo['id'])}
                {l s='Edit donation' mod='wkcharitydonation'}
            {else}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <span class="switch prestashop-switch fixed-width-lg">
                                    ...
                                    {if isset($smarty.post.show_donate_button) && $smarty.post.show_donate_button == 1}
                                        <input type="radio" name="show_donate_button" id="show_donate_button_off" value="0" {if isset($smarty.post.show_donate_button) && $smarty.post.show_donate_button == 0}checked="checked"{/if}>
                                    {else}
