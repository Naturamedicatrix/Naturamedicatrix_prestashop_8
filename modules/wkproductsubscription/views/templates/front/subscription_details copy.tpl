...
{block name="content"}
    ...
    {/if}
    <section id="main" class="wk-product-subscription">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="float-md-right">
                        <a class="btn btn-primary btn-sm" href="{$backLink|escape:'htmlall':'UTF-8'}">
                            <i class="material-icons">keyboard_arrow_left</i>{l s='Back' mod='wkproductsubscription'}
                        </a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card card-block">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <strong
                                            class="product-price">{$subsDetails.unit_price|escape:'htmlall':'UTF-8'}</strong>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="text-center">
                                            {if $subsDetails.allow_actions}
                                                {if $subsDetails.active == WkSubscriberProductModal::WK_SUBS_STATUS_ACTIVE}
                                                    {if $can_cancel}
                                                        <button type="button" class="btn btn-danger" id="cancelSubscription">
                                                ...
                                                {elseif $subsDetails.active == WkSubscriberProductModal::WK_SUBS_STATUS_CANCELLED}
                                                    ...
                                                    <div class="product-variants">
                                                        <button type="button" class="btn btn-danger  btn-block" id="deleteSubscription">
