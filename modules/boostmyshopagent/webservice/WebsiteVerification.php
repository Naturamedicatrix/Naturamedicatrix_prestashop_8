...
try {
    ...
    if (!$apiKey || !$token) {
        ...
        throw new Exception('api_key or token missing');
    }
    ...
    Configuration::updateValue('BMS_GSC_AGENT_SITE_VERIFICATION_TOKEN', $token);
    $data['message'] = 'Google site verification token updated';
} catch (Exception $e) {
    $data['success'] = false;
