...
*
*}
<nav id="cbp-hrmenu1" class="cbp-hrmenu  iqitmegamenu-all cbp-vertical  {if $menu_settings_v.ver_animation==1}cbp-fade{/if} {if !$menu_settings_v.ver_arrow} cbp-submenu-notarrowed{/if} {if !$menu_settings_v.ver_arrow} cbp-submenu-notarrowed{/if}  ">
