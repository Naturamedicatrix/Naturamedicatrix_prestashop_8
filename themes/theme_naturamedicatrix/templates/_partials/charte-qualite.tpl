<section class="relative my-24 px-4">
  <div class="relative bg-white rounded-xl border border-gray-200 shadow-sm p-8 max-w-5xl mx-auto transition-transform duration-300 hover:scale-105">
    
    <!-- Icône positionnée en haut à droite -->
    <div class="absolute top-4 right-4 text-primary text-4xl">
      <i class="bi bi-patch-check-fill"></i>
    </div>

    <h2 class="text-center text-2xl sm:text-3xl font-semibold text-gray-800 mb-4">
    ...
    <p class="text-center text-gray-600 mt-0">
      ...
      Notre département Qualité reste à votre disposition pour tout complément d’information.
    </p>
  </div>
</section>
