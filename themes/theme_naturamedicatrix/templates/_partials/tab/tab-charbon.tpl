...
<p class="heading text-center" id="compare" style="text-transform: initial;">
    	<span>Différences entre nos charbons végétaux activés</span>
...
<table class="table table-bordered table-striped table-compare">
        <thead>
            <tr>
                <th></th>
                <th><a href="{$link->getProductLink(708)|escape:'html':'UTF-8'}">Charbon Activ' (gélules)</a></th>
                <th><a href="{$link->getProductLink(709)|escape:'html':'UTF-8'}">Charbon Activ' + Myrtille (gélules)</a></th>
                <th><a href="{$link->getProductLink(692)|escape:'html':'UTF-8'}">Charbon Activ' (poudre)</a></th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td class="row-title">Composition</td>
                <td class="col-md-3">Charbon végétal activé</td>
                <td class="col-md-3">Charbon végétal activé + Poudre de myrtille</td>
                <td class="col-md-3">Charbon végétal activé</td>
            </tr>
            <tr>
                <td class="row-title">Galénique</td>
                <td>Gélule</td>
                <td>Gélule</td>
                <td>Poudre</td>
            </tr>
            <tr class="highlight">
                <td class="row-title">Dosage</td>
                <td>250 mg/gélule</td>
                <td>200 mg de charbon + 80 mg de myrtille dans une gélule</td>
                <td>1500 mg/½ c. à café</td>
            </tr>
            <tr>
                <td class="row-title">Capacité d'Adsorption</td>
                <td>2000 m²/g/minute & indice phénazone 40 % minimum</td>
                <td>2000 m²/g/minute & indice phénazone 40 % minimum</td>
                <td>Indice phénazone 40 % minimum</td>
            </tr>
            <tr class="highlight">
                <td class="row-title">Bénéfices supplémentaires</td>
                <td>Confort digestif</td>
                <td>Confort digestif + Soutien des muqueuses</td>
                <td>Confort digestif</td>
            </tr>
            <tr>
                <td class="row-title">Prise quotidienne recommandée</td>
                <td>2 à 8 gélules</td>
                <td>2 à 10 gélules</td>
                <td>½ à 1 c. à café/jour</td>
            </tr>
        </tbody>
    </table>
