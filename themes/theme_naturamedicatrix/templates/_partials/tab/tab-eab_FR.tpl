...
<p class="heading text-center" id="compare">
    <span>{l s="Compare of Dr. Jacob's® Alkalising Formulas"}</span>
    	<svg>
    ...
    {l s=''}
<p class="text-center"><a class="btn btn-success btn-flat btn-lg" role="button" data-toggle="collapse" href="#collapseCafe" aria-expanded="false" aria-controls="collapseCafe"> » {l s='Compare and choose your alkalizing formula'}</a></p>
{else}<p class="heading text-center" id="compare">
          <a class="heading-link" href="{$link->getCategoryLink({8})}" title="{l s='The complete range for your acid-base balance'}">» {l s='All our alkalizing products'}</a>
    <span>{l s="Compare of Dr. Jacob's® Alkalising Formulas"}</span>
    <svg style="background: #f5f5f5">
        <use xlink:href="#headingsvg">
            <svg viewBox="0 0 365 100.1" id="headingsvg" style="background: whitesmoke;">
                <path class="st0" d="M364.6,92.9c-2.6-3.7-2.6-8.3-3.8-12.5c-1-3.5-3-6.5-5.6-9c-4.4-4.2-11.4-5.3-17.2-7.1
            c-1.8-1.7-3.6-3.3-5.6-4.9c-0.1-0.2-0.3-0.3-0.5-0.5c-4-3.1-7.9-6.1-11.8-9c3,1.1,6.3,1.6,9.3,1.7c9.7,0.2,18.9-4.3,25.1-11.6
            c1.6-1.9,0.5-4.4-1.9-4.6c-4.6-0.5-8.4-3.9-12.5-5.6c-3.1-1.2-6.6-1.5-9.9-1c-5.8,0.9-10.9,5.2-15.9,8.3l-2.8,0.5
            c-5,0.9-10.1,0.1-14.6-2.2c-5.7-2.9-11.6-5.3-18-7.1c-0.2-0.1-0.5-0.2-0.7-0.2c-0.9-0.2-1.8-0.5-2.7-0.7c-4.4-1.1-8.9-1.8-13.3-2.3
...
<table class="table table-bordered table-striped table-compare">
      <thead>
        <tr>
            <th class="text-center" style="background: none; width: 12.50%;"></th>
            <th class="text-center" style="background: none; width: 12.50%;">
                <a href="{$link->getProductLink({687})}" title="Formule Alcalinisante Pur">
                    <span class="label label-new new">{l s='New'}</span>
                    <img class="lazy" data-src="/2755-medium/formule-alcalinisante-pur.jpg" alt="Formule Alcalinisante Pur" width="80" height="80" /><br />
                    <span>Formule Alcalinisante Pur</span>
                </a>
            </th>
            <th class="text-center" style="background: none; width: 12.50%;">
                <a href="{$link->getProductLink({15})}" title="Formule Alcalinisante (Poudre)">
                    <img class="lazy" data-src="/2792-medium/formule-alcalinisante.jpg" alt="Formule Alcalinisante (Poudre)" width="80" height="80" /><br />
                    <span>Formule Alcalinisante (Poudre)</span> 
                </a>
            </th>
            <th class="text-center" style="background: none; width: 12.50%;">
                <a href="{$link->getProductLink({96})}" title="Formule Alcalinisante (Comprimés)">
                    <img class="lazy" data-src="/2793-medium/formula-alcalinisante-comprime.jpg" alt="Formule alcalinisante (Comprimé)" width="80" height="80" /><br />
                    <span>Formule Alcalinisante (Comprimé)</span>
                </a>
            </th>
            <th class="text-center" style="background: none; width: 12.50%;">
                <a href="{$link->getProductLink({175})}" title="Formule Alcalinisante Plus">
                    <img class="lazy" data-src="/2794-medium/formule-alcalinisante-plus.jpg" alt="Formule alcalinisante Plus" width="80" height="80" /><br />
                    <span>Formule Alcalinisante Plus</span> 
                </a>
            </th>
            <th class="text-center" style="background: none; width: 12.50%;">
                <a href="{$link->getProductLink({35})}" title="Alca-Melisse-B+">
                    <img class="lazy" data-src="/2436-medium/alca-melisse-b.jpg" alt="Alca-Melisse-B+" width="80" height="80" /><br />
                    <span>Alca-Melisse-B+</span> 
                </a>
            </th>
            <th class="text-center" style="background: none; width: 12.50%;">
                <a href="{$link->getProductLink({284})}" title="pHysioBase">
                    <img class="lazy" data-src="/2440-medium/physiobase.jpg" alt="pHysioBase" width="80" height="80" /><br />
                    <span>pHysioBase</span>
                </a>
            </th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td colspan="7" class="info text-left" style="color: #ffffff;"><strong>Minéraux</strong></td>
        </tr>
        <tr>
            <td>Sodium</td>
        ...
        <tr>
            <td colspan="7" class="info text-left" style="color: #ffffff;"><strong>Vitamines</strong></td>
        </tr>
        <tr>
            <td>Vitamine D*</td>
            <td><span style="color:#d86c6c;">✘</span></td>
        ...
        <tr>
            <td>Complexe de vitamines&nbsp;B*</td>
            <td><span style="color:#d86c6c;">✘</span></td>
            <td>vitamine B1<br/>0,7 mg</td>
            <td><span style="color:#d86c6c;">✘</span></td>
            <td>vitamine B1<br/>0,42 mg</td>
            <td><span style="color:#48b35b;">✔</span></td>
            <td>vitamine B1<br/>0,4 mg</td>
        </tr>
        <tr>
            <td colspan="7" class="info text-left" style="color: #ffffff;"><strong>Ingrédients</strong></td>
        </tr>
        <tr>
            <td>Citrates</td>
            <td>64%</td>
        ...
        <tr>
            <td colspan="7" class="info text-left" style="color: #ffffff;"><strong>Caractéristiques du produit</strong></td>
        </tr>
        ...
        <tr>
            <td>Valeur PRAL**</td>
            <td>-24,14<br/>
                <small>La quantité correspond à la valeur PRAL de 817 g de Fruits/légumes</small></td>
            <td>-24,07<br/>
                <small>La quantité correspond à la valeur PRAL de 814 g de Fruits/légumes</small></td>
            <td>-18,95<br/>
                <small>La quantité correspond à la valeur PRAL de 641 g de Fruits/légumes</small></td>
            <td>-24,14<br/>
                <small>La quantité correspond à la valeur PRAL de 817 g de Fruits/légumes</small></td>
            <td>-22,35<br/>
                <small>La quantité correspond à la valeur PRAL de 756 g de Fruits/légumes</small></td>
            <td>-20,33<br/>
                <small>La quantité correspond à la valeur PRAL de 688 g de Fruits/légumes</small></td>
        </tr>

        <tr>
            <td>Goût</td>
            <td>Neutre</td>
            <td>Neutre avec une note de citron, non sucré</td>
            <td>Neutre</td>
            <td>Fruité (vrais morceaux de citron) + stévia</td>
            <td>Neutre</td>
            <td>Fruité avec baies + stévia</td>
        </tr>
        <tr>
            <td>Quantité</td>
            <td>200 g / ± 36 portions</td>
            <td>300 g / ± 66 portions</td>
            <td>250 comprimés / 62 portions</td>
            <td>300 g / ± 50 portions</td>
            <td>250 comprimés / 50 portions</td>
            <td>300 g / ± 50 portions</td>
        </tr>
        <tr>
            <td>Prix</td>
...
<p><small> 1 portion = 1 mesure<br/>
    1 mesure de Formule Alcalinisante pur, poudre et plus, 5 comprimés d’Alca-Melisse B+ et 4 comprimés de Formule Alcalinisante comprimés.</small></p>
<p><small>
    ✔ Tous les produits sont sans gluten, ni lactose, ni sucre, sans sodium ajouté, ni arômes artificiels, ni colorants, ni conservateurs.<br />
    ✔ Tous les produits sont végan.
    </small></p>

<p><small> **La valeur PRAL (PRAL : Potential Renal Acid Load)(pour la posologie maximale) est une valeur fréquemment utilisée pour évaluer l'effet acidifiant ou alcalinisant des aliments. Cette valeur indique la charge acide potentielle des reins (ou la production d'acide) induite par la consommation d’un aliment.</small></p>
<p><small> Plus la valeur est élevée, plus l'excrétion d'acide par les reins est importante.</small></p>

<p><small> ✔ Les aliments ayant une valeur PRAL négative sont alcalins, équilibrent les acides et soulagent ainsi les reins.<br/>
✔ Plus la valeur PRAL est négative, plus les acides sont équilibrés.</small></p>
