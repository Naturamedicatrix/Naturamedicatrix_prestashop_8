...
{assign var="productA" value=Product::getCover(313)}
{assign var="productB" value=Product::getCover(736)}
{assign var="productC" value=Product::getCover(675)}
{assign var="productD" value=Product::getCover(646)}
{assign var="productE" value=Product::getCover(368)}
{assign var="productF" value=Product::getCover(672)}


<p class="heading text-center" id="compare" style="text-transform: initial;">
    	<span>Différences entre nos produits à base d'Omega</span>
...
<thead>
  <tr>
    <th></th>
    <th style="background: #e4f2ff; text-align: center; vertical-align: middle;"><a href="{$link->getProductLink(313)|escape:'html':'UTF-8'}"><img id="thumb_754" src="{$link->getImageLink($product->link_rewrite, $productA.id_image, 'small_default')|escape:'html':'UTF-8'}" alt="Omega-3" width="80" height="80" /><br />Omega-3</a></th>
    <th style="background: #e4f2ff; text-align: center; vertical-align: middle;"><a href="{$link->getProductLink(736)|escape:'html':'UTF-8'}"><img id="thumb_754" src="{$link->getImageLink($product->link_rewrite, $productB.id_image, 'small_default')|escape:'html':'UTF-8'}" alt="Omega-3" width="80" height="80" /><br />Omega-11</th>
    <th style="background: #e4f2ff; text-align: center; vertical-align: middle;"><a href="{$link->getProductLink(675)|escape:'html':'UTF-8'}"><img id="thumb_754" src="{$link->getImageLink($product->link_rewrite, $productC.id_image, 'small_default')|escape:'html':'UTF-8'}" alt="Omega-3" width="80" height="80" /><br />Omega-7 Argousier</th>
    <th style="background: #e4f2ff; text-align: center; vertical-align: middle;"><a href="{$link->getProductLink(646)|escape:'html':'UTF-8'}"><img id="thumb_754" src="{$link->getImageLink($product->link_rewrite, $productD.id_image, 'small_default')|escape:'html':'UTF-8'}" alt="Omega-3" width="80" height="80" /><br />Ubiquinol Omega</th>
    <th style="background: #e4f2ff; text-align: center; vertical-align: middle;"><a href="{$link->getProductLink(368)|escape:'html':'UTF-8'}"><img id="thumb_754" src="{$link->getImageLink($product->link_rewrite, $productE.id_image, 'small_default')|escape:'html':'UTF-8'}" alt="Omega-3" width="80" height="80" /><br />Calanus</th>
    <th style="background: #e4f2ff; text-align: center; vertical-align: middle;"><a href="{$link->getProductLink(672)|escape:'html':'UTF-8'}"><img id="thumb_754" src="{$link->getImageLink($product->link_rewrite, $productF.id_image, 'small_default')|escape:'html':'UTF-8'}" alt="Omega-3" width="80" height="80" /><br />NeurOmega</th>
  </tr>
</thead>
<tbody>
  <tr>
  ...
  <tr>
    <th>Atouts</th>
    <td>EPA et DHA purs sans contaminants.</td>
    <td>Mélange unique d'oméga-3 9 et 11 avec des EPA, DHA et des acides gras mono-insaturés à longue chaîne.</td>
    <td>Riche en Oméga-7 rare dans l'alimentation.</td>
    <td>Synergie d'Ubiquinol (forme active de la Q10) avec EPA et DHA purs et sans contaminants.</td>
    <td>Forme d’acides gras particuliers (esters de cire) qui activent les récepteurs de l’intestin distal. Considérablement plus riche en astaxanthine que le krill.</td>
    <td>Ratio EPA / DHA très élevé enrichi en GLA issu d'huile de bourrache.</td>
  </tr>
  <tr>
    <th>Formes d'acides gras</th>
    <td>2 capsules <ul><li>EPA : 400 mg</li><li>DHA : 300 mg</li></ul></td>
    <td>2 capsules <ul><li>Omega-11 (Acide cétoléique) : 300 mg</li><li>Omega-9 (Acide gondoïque) : 90 mg</li><li>Omega-3 (DHA : 200 mg, EPA : 50 mg)</li></ul></td>
    <td>6 capsules<ul><li>Omega-7 : 900 mg</li><li>Omega-9 : 510 mg</li><li>Omega-3 : 390 mg</li><li>Omega-6 : 300 mg</li></ul></td>
    <td>1 capsule<ul><li>EPA : 918 mg</li><li>DHA : 601 mg</li><li>Ubiquinol : 50 mg</li></ul></td>
    <td>2 capsules<ul><li>Esters de cire : 900 mg</li><li>SDA : 73 mg</li><li>EPA : 70 mg</li><li>DHA : 56 mg</li><li>Omega-11 : 30 mg</li></ul></td>
    <td>1 c. à café<ul><li>EPA : 1290 mg</li><li>DHA : 250 mg</li><li>GLA : 175 mg</li></ul></td>
  </tr>
  <tr>
    <th>Bienfaits</th>
    <td>Cerveau, Vision et Cœur.</td>
    <td>Cœur.</td>
    <td>Peau, Muqueuses et Cœur.</td>
    <td>Cœur, Cerveau, protection contre le stress oxydant.</td>
    <td>Cœur.</td>
    <td>Cerveau.</td>
  </tr>
  <tr>
    <th>Mode d'emploi</th>
    <td>1 à 2 gélules par jour.</td>
    <td>2 gélules par jour.</td>
    <td>2 à 4 gélules par jour (max 6).</td>
    <td>1 gélule par jour.</td>
    <td>2 gélules par jour (max 4).</td>
    <td>25 mL (3-9 ans), 5 mL (10+ ans) par jour.</td>
  </tr>
  <tr>
    <th>Nombre de gélules par pot</th>
    <td>60 gélules</td>
    <td>60 gélules</td>
    <td>60 gélules</td>
    <td>60 gélules</td>
    <td>60 gélules</td>
    <td>150 mL (liquide)</td>
  </tr>
</tbody>
</table>
