{assign var="productA" value=Product::getCover(710)}
{assign var="productB" value=Product::getCover(306)}

<p class="heading text-center" id="compare" style="text-transform: initial;">
    	<span>Différences entre <a href="{$link->getProductLink(710)|escape:'html':'UTF-8'}" title="Neuro-AD Gummies">Neuro-AD Gummies</a> et <a href="{$link->getProductLink(306)|escape:'html':'UTF-8'}" title="Neuro-AD Concentration gélules">Neuro-AD Concentration gélules</a></span>
...
<table class="table table-bordered table-striped table-compare">
  <thead>
    <tr>
      <th></th>
      <th><a href="{$link->getProductLink(710)|escape:'html':'UTF-8'}" title="Neuro-AD Gummies"><img id="thumb_754" src="{$link->getImageLink($product->link_rewrite, $productA.id_image, 'small_default')|escape:'html':'UTF-8'}" alt="Neuro-AD Gummies" width="80" height="80" /><br />Neuro-AD Gummies</a></th>
      <th><a href="{$link->getProductLink(306)|escape:'html':'UTF-8'}" title="Neuro-AD Concentration gélules"><img id="thumb_754" src="{$link->getImageLink($product->link_rewrite, $productB.id_image, 'small_default')|escape:'html':'UTF-8'}" alt="Neuro-AD Concentration gélules" width="80" height="80" /><br />Neuro-AD Concentration gélules</a></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Forme</td>
      <td>Gummies sans sucres</td>
      <td>Gélules sans sucres</td>
    </tr>
    <tr>
      <td>Facilité de consommation</td>
      <td>Très facile <br> --> gummies</td>
      <td>Moyenne <br> --> gélules</td>
    </tr>
    <tr>
      <td>Goût</td>
      <td>Framboise/Fraise Tagada</td>
      <td>Neutre</td>
    </tr>
    <tr>
      <td>Principaux Ingrédients</td>
      <td>Pour 4 gummies :</td>
    ...
    <tr>
      ...
      <td>2 à 4 gummies par jour</td>
      <td>2 à 4 gélules par jour</td>
    </tr>
    <tr>
      <td>Adapté pour</td>
      <td>Enfants dès 4 ans et adultes</td>
      <td>Enfants dès 4 ans et adultes</td>
    </tr>
  </tbody>
</table>
