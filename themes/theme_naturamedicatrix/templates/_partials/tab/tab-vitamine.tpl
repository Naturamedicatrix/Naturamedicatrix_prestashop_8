...
<table class="table table-bordered table-striped table-compare"><caption>Tableau comparatif</caption>
	...
	<tr>
		<th>#</th>
		<th><a class="img-product_link" href="{$link->getProductLink(307)|escape:'htmlall':'UTF-8'}"> <img class="deffimg deffprio5" src="/themes/new-natura/img/blank.gif" data-deffimg="/2516-small_default/vitamine-d3.jpg" alt="Vitamine D3" width="98" height="98" /><br /> Vitamine D3</a></th>
        <th><a class="img-product_link" href="{$link->getProductLink(349)|escape:'htmlall':'UTF-8'}"> <img class="deffimg deffprio5" src="/themes/new-natura/img/blank.gif" data-deffimg="/2513-small_default/vitamine-d3-forte.jpg" alt="Vitamine D3 Forte" width="98" height="98" /><br /> Vitamine D3 Forte</a></th>
        <th><a class="img-product_link" href="{$link->getProductLink(259)|escape:'htmlall':'UTF-8'}"> <img class="deffimg deffprio5" src="/themes/new-natura/img/blank.gif" data-deffimg="/2514-small_default/vitamines-d3k2.jpg" alt="Vitamine D3K2" width="98" height="98" /><br /> Vitamine D3K2</a></th>
        <th><a class="img-product_link" href="{$link->getProductLink(550)|escape:'htmlall':'UTF-8'}"> <img class="deffimg deffprio5" src="/themes/new-natura/img/blank.gif" data-deffimg="/2515-small_default/vitamine-d3k2-2000-ui-50-g.jpg" alt="Vitamine D3K2 Forte" width="98" height="98" /><br /> Vitamine D3K2 Forte</a></th>
        <th><a class="img-product_link" href="{$link->getProductLink(599)|escape:'htmlall':'UTF-8'}"> <img class="deffimg deffprio5" src="/themes/new-natura/img/blank.gif" data-deffimg="/2519-small_default/vitamine-k2d3.jpg" alt="Vitamine K2D3" width="98" height="98" /><br /> Vitamine K2D3</a></th>
        <th><a class="img-product_link" href="{$link->getProductLink(572)|escape:'htmlall':'UTF-8'}"> <img class="deffimg deffprio5" src="/themes/new-natura/img/blank.gif" data-deffimg="/2518-small_default/vitamine-k2.jpg" alt="Vitamine K2" width="98" height="98" /><br /> Vitamine K2</a></th>
        <th><a class="img-product_link" href="{$link->getProductLink(562)|escape:'htmlall':'UTF-8'}"> <img class="deffimg deffprio5" src="/themes/new-natura/img/blank.gif" data-deffimg="/2517-small_default/vitamine-deka.jpg" alt="Vitamine DEKA" width="98" height="98" /><br /> Vitamine DEKA</a></th>
	</tr>
	</thead>
	<tbody>
		<tr>
