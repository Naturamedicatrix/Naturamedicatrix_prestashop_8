...
{assign var="productA" value=Product::getCover(668)}
{assign var="productB" value=Product::getCover(669)}
{assign var="productC" value=Product::getCover(734)}


<p class="heading text-center" id="compare" style="text-transform: initial;">
    	<span>Différences entre <a href="{$link->getProductLink(668)|escape:'html':'UTF-8'}">Café Keto</a>, <a href="{$link->getProductLink(669)|escape:'html':'UTF-8'}">Cacao Keto</a> et <a href="{$link->getProductLink(734)|escape:'html':'UTF-8'}">Collagène marin</a></span>
...
<tr>
  ...
  <th style="background: #e4f2ff; text-align: center; vertical-align: middle;"><a href="{$link->getProductLink(668)|escape:'html':'UTF-8'}"><img id="thumb_754" src="{$link->getImageLink($product->link_rewrite, $productA.id_image, 'small_default')|escape:'html':'UTF-8'}" alt="Café Keto" width="80" height="80" /><br /><span>Café Keto</span> </a>
  
  </th>
  
  <th style="background: #e4f2ff; text-align: center; vertical-align: middle;"><a href="{$link->getProductLink(669)|escape:'html':'UTF-8'}"><img id="thumb_754" src="{$link->getImageLink($product->link_rewrite, $productB.id_image, 'small_default')|escape:'html':'UTF-8'}" alt="Cacao Keto" width="80" height="80" /><br /><span>Cacao Keto</span> </a></th>
  
  
  <th style="background: #e4f2ff; text-align: center; vertical-align: middle;"><a href="{$link->getProductLink(734)|escape:'html':'UTF-8'}"><img id="thumb_754" src="{$link->getImageLink($product->link_rewrite, $productC.id_image, 'small_default')|escape:'html':'UTF-8'}" alt="Collagène marin" width="80" height="80" /><br /><span>Collagène marin</span> </a></th>
...
<td>
TCM issus d’huile de noix de coco (45%) ; Naticol® : collagène d’origine marine (25%); poudre de café soluble (20%) ; poudre de lait de coco  (10%).
</td>
<td>
TCM issus d’huile de noix de coco (52,5%) ; poudre de cacao (20%); Naticol® : collagène d’origine marine (12,5%) ; poudre de lait de coco (10%) ; glycine (5%).
</td>
...
<p>Collagène marin (Naticol®) + TCM + Café ou Cacao</p>
<p>Dosage fort en collagène dans la version café et additionné de glycine dans la version cacao.</p>
<p>Sans sucres, ni gluten, ni lactose - Faible en sel.</p>