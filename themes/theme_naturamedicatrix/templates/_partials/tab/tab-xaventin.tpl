<p class="heading text-center" id="compare" style="text-transform: initial;">
    	<span>Différences entre Xaventin en <a href="{$link->getProductLink(232)|escape:'html':'UTF-8'}">sachet</a> et en <a href="{$link->getProductLink(223)|escape:'html':'UTF-8'}">comprimés</a></span>
...
<tr>
  ...
  <th><a href="{$link->getProductLink(232)|escape:'html':'UTF-8'}"><img id="thumb_754" src="/2535-small_default/xaventin-14-sachets.jpg" alt="Xaventin 14 sachets" width="80" height="80" /><br /><span>Xaventin (14 sachets)</span> </a></th>
  
  <th><a href="{$link->getProductLink(223)|escape:'html':'UTF-8'}"><img id="thumb_754" src="/2533-small_default/xaventin-comprimes.jpg" alt="Xaventin (comprimés)" width="80" height="80" /><br /><span>Xaventin (comprimés)</span> </a></th>
...
<tr>
<td>Forme</td>
<td>Poudre (dissoudre dans de l'eau)</td>
<td>Comprimé (à avaler avec un verre d'eau)</td>
</tr>
<tr>
<td>Principe actif</td>
<td colspan="2">Xaventin pulvis</td>
</tr>
<tr>
  <td>Consommation en fonction du poids</td>
<td><ul><li>En dessous de 50 kg = 1/2 sachet / j</li><li>En 50 et 90 kg = 1 sachet / j</li><li>Plus de 90 kg = 2 sachets / j</li></ul></td>
<td><ul><li>En dessous de 50 kg = 2 x 4 comprimés / j</li><li>En 50 et 90 kg = 2 x 5 comprimés / j</li><li>Plus de 90 kg = 2 x 7 comprimés / j</li></ul></td>
</tr>
<tr>
<td>Conservation</td>
<td>En dessous de <strong>15°C</strong></td>
<td>En dessous de <strong>22°C</strong></td>
</tr>
<tr>
<td>Diabétiques</td>
<td>Contient du sucre</td>
<td>Pauvre en sucre</td>
</tr>
<tr>
<td>Conditionnement</td>
<td>1 boîte = 14 sachets</td>
<td>1 flacon = 150 comprimés</td>
</tr>
