<p class="heading text-center" id="compare" style="text-transform: initial;">
    	<span>Tableau de comparaison des Jus d'Aloe Vera — Pur'Aloé</span>
...
<table>
        <tr>
            ...
            <th><a href="{$link->getProductLink('714')}" title="Jus d'Aloé Arborescens">Jus d'Aloé Arborescens</a></th>
            <th><a href="{$link->getProductLink('733')}" title="Jus d'Aloé Vera">Jus d'Aloé Vera</a></th>
            <th><a href="{$link->getProductLink('730')}" title="Gel d'Aloé Vera">Gel d'Aloé Vera</a></th>
            <th><a href="{$link->getProductLink('728')}" title="Jus Pétillant d'Aloé Vera">Jus Pétillant d'Aloé Vera</a></th>
        </tr>
        <tr>
            <td>Ingrédients principaux</td>
            <td>99,8% Aloé Arborescens</td>
            <td>99,67% Aloé Vera</td>
            <td>99,27% Aloé Vera</td>
            <td>98,2% Aloé Vera</td>
        </tr>
        <tr>
            <td>Texture</td>
            <td>Liquide</td>
            <td>Liquide</td>
            <td>Gel</td>
            <td>Liquide pétillant</td>
        </tr>
        <tr>
            <td>Conservation</td>
            <td>Réfrigérateur (4 semaines)</td>
            <td>Réfrigérateur (4 semaines)</td>
            <td>Réfrigérateur (4 semaines)</td>
            <td>Réfrigérateur (10 jours)</td>
        </tr>
        <tr>
            <td>Utilisation</td>
            <td>1 cuillère à soupe 2x/jour avant repas</td>
            <td>2 cuillères à soupe avant repas</td>
            <td>2 cuillères à soupe avant repas</td>
            <td>1 verre avant repas</td>
        </tr>
        <tr>
            <td>Bienfaits</td>
            <td>Immunité, Métabolisme, Digestion</td>
            <td>Immunité, Métabolisme, Digestion</td>
            <td>Immunité, Métabolisme, Digestion</td>
            <td>Microbiote, Digestion, Anti-oxydant</td>
        </tr>
        <tr>
    ...
    <h2>Choisir le Complément Alimentaire qui Vous Convient</h2>
    <p><strong><a href="{$link->getProductLink('714')}" title="Jus d'Aloé Arborescens">Jus d'Aloé Arborescens</a> :</strong> Parfait pour ceux qui recherchent un soutien immunitaire et digestif avec un produit biologique pur et éthique, composé d’Aloe arborescens.</p>
    <p><strong><a href="{$link->getProductLink('733')}" title="Jus d'Aloé Vera">Jus d'Aloé Vera</a> :</strong> Idéal pour une hydratation intérieure et un soutien immunitaire et digestif, tout en étant léger et rafraîchissant. Un produit biologique pur et éthique, composé d’Aloe vera.</p>
    <p><strong><a href="{$link->getProductLink('730')}" title="Gel d'Aloé Vera">Gel d'Aloé Vera</a> :</strong> Pour une texture plus épaisse, ce gel est parfait pour ceux qui préfèrent un produit plus visqueux avec des bienfaits similaires au jus.</p>
    <p><strong><a href="{$link->getProductLink('728')}" title="Jus Pétillant d'Aloé Vera">Jus Pétillant d'Aloé Vera</a> :</strong> Le choix idéal pour un confort digestif avec une touche pétillante et rafraîchissante.</p>
    <p>Profitez des bienfaits naturels de l'Aloé pour votre bien-être quotidien.</p>
