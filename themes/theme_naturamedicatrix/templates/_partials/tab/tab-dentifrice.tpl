<p class="heading text-center" id="compare" style="text-transform: initial;">
    	<span>Tableau de comparaison des dentifrices</span>
...
<table>
        <tr>
            ...
            <th><a href="{$link->getProductLink('722')}" title="Dentifrice Argile/Eau thermale - Citron Bio">Dentifrice Argile/Eau thermale - Citron Bio</a></th>
            <th><a href="{$link->getProductLink('720')}" title="Dentifrice Aloé Vera Natif Bio - Menthe">Dentifrice Aloé Vera Natif Bio - Menthe</a></th>
        </tr>
        <tr>
            <td>Principaux ingrédients actifs</td>
            <td>
                Argile blanche (35%)<br>
                Eau thermale (33%)<br>
                Extraits de mélisse bio<br>
                Extraits d’écorce de citron bio<br>
                Sel marin non raffiné
            </td>
            <td>
                Jus d'Aloé Vera natif (70%)<br>
                Cristaux de cellulose<br>
        ...
        <tr>
            <td>Propriétés</td>
            <td>
                Protège des caries<br>
                Absorbe les mauvaises odeurs<br>
                Cicatrise et reminéralise les gencives<br>
                Réduit les matières mortes<br>
                Astringent
            </td>
            <td>
                Protège les gencives sensibles<br>
                Apaisant<br>
                Fraîcheur intense
            </td>
        </tr>
        <tr>
            <td>Naturel et biologique</td>
            <td>
                14% Biologique<br>
        ...
        <tr>
            ...
            <td>
                COSMOS ORGANIC<br>
                Commerce Équitable (Fair For Life)<br>
                Vegan
            </td>
        </tr>
        <tr>
            <td>Type de tube</td>
            <td>Déchets de canne à sucre</td>
            <td>Déchets de canne à sucre</td>
        </tr>
        <tr>
            <td>Goût</td>
        ...
        <tr>
            <td>Adapté pour</td>
            <td>
                Gencives fragiles et sensibles<br>
                Utilisation quotidienne pour toute la famille
            </td>
            <td>
                Gencives fragiles et sensibles<br>
                Utilisation quotidienne pour toute la famille
...
<h2>Choisir le bon dentifrice selon vos besoins</h2>
    <p>Deux dentifrices naturels et efficaces s'offrent à vous pour prendre soin de votre hygiène bucco-dentaire : <a href="{$link->getProductLink('722')}" title="Dentifrice Argile/Eau thermale - Citron Bio">le Dentifrice Argile/Eau thermale</a> - Citron Bio et le <a href="{$link->getProductLink('720')}" title="Dentifrice Aloé Vera Natif Bio - Menthe">Dentifrice Aloé Vera Natif Bio & Equitable - Menthe</a>. Voici comment ils se distinguent pour vous aider à faire le meilleur choix.</p>
    <p>Le Dentifrice <a href="{$link->getProductLink('722')}" title="Dentifrice Argile/Eau thermale - Citron Bio">Argile/Eau thermale - Citron Bio</a> est formulé avec 35% d'argile blanche et 33% d'eau thermale de Digne les Bains, reconnus pour leurs propriétés reminéralisantes et apaisantes. Il contient également des extraits de mélisse bio et d’écorce de citron bio. Ce dentifrice protège vos dents des caries, absorbe les mauvaises odeurs et cicatrise les gencives grâce à l'action synergique de ses ingrédients riches en minéraux et oligo-éléments. Sa composition est à 99.3% d'origine naturelle et 14% biologique, certifiée COSMOS ORGANIC.</p>
    <p>Le Dentifrice <a href="{$link->getProductLink('720')}" title="Dentifrice Aloé Vera Natif Bio - Menthe">Aloé Vera Natif Bio & Equitable</a>, quant à lui, se distingue par sa teneur élevée en jus d'Aloé Vera natif (70%), ce qui en fait un puissant astringent pour protéger et apaiser les gencives sensibles. Enrichi en cristaux de cellulose et huile essentielle de menthe bio, il offre une fraîcheur intense et une excellente efficacité de nettoyage. Avec 70,2% d'ingrédients biologiques et 99,35% d'origine naturelle, il dépasse largement les standards de la cosmétique bio. Ce produit est également certifié COSMOS ORGANIC et bénéficie du label Commerce Équitable (Fair For Life).</p>
    <h2>Pourquoi choisir l'un plutôt que l'autre ?</h2>
    <ul>
      <li>
    <p><strong><a href="{$link->getProductLink('722')}" title="Dentifrice Argile/Eau thermale - Citron Bio">Dentifrice Argile/Eau thermale - Citron Bio</a> :</strong> Idéal pour ceux qui recherchent une protection contre les caries tout en apaisant les gencives fragiles. Il est particulièrement recommandé pour ceux souhaitant une action reminéralisante et cicatrisante grâce à l'argile blanche et à l'eau thermale.</p>
      </li>
      <li>
    <p><strong><a href="{$link->getProductLink('720')}" title="Dentifrice Aloé Vera Natif Bio - Menthe">Dentifrice Aloé Vera Natif Bio & Equitable</a> :</strong> Parfait pour les personnes ayant des gencives sensibles qui nécessitent une protection et un apaisement particulier. L'Aloé Vera natif offre des propriétés astringentes et apaisantes, complétées par une fraîcheur intense grâce à la menthe bio.</p>
      </li>
    </ul>
    <p>Ces deux dentifrices respectent l'environnement avec leurs tubes fabriqués à partir de déchets de canne à sucre, réduisant ainsi la dépendance aux matières plastiques d'origine pétrolière. Quel que soit votre choix, vous adoptez une routine dentaire naturelle et respectueuse de votre santé et de l'environnement.</p>