      ...
      <div class="container">
        ...
        <div class="relative grid grid-cols-1 md:grid-cols-3 gap-16 max-w-6xl mx-auto py-12 px-4 md:px-8 items-stretch">
          ...
          <div class="flex flex-col h-full">
            <div>
              <h3 class="text-lg font-bold tracking-wide">{l s='Livraison offerte' d='Shop.Theme.Global'}</h3>
            </div>
            <div class="flex-grow">
              <p class="text-sm text-gray-600 font-medium">{l s='À partir de 35€ en point relais ou 50€ en livraison à domicile (France métropolitaine, Belgique ou Luxembourg).' d='Shop.Theme.Global'}</p>
            </div>
            <div class="mt-1.5 color-text">
              » <a href="#" class="text-sm color-text underline font-semibold hover:underline underline-offset-2">{l s='Profiter de la livraison offerte' d='Shop.Theme.Global'}</a>
            </div>
          </div>
          
          <div class="flex flex-col h-full">
            <div>
              <h3 class="text-lg font-bold tracking-wide">{l s='Remise sur le total de la commande' d='Shop.Theme.Global'}</h3>
            </div>
            <div class="flex-grow">
              <p class="text-sm text-gray-600 font-medium">{l s='-10% dès 150€ et -5% dès 75€ d\'achat, automatiquement appliqués sur votre panier, sans code.' d='Shop.Theme.Global'}</p>
            </div>
            <div class="mt-1.5 color-text">
             » <a href="#" class="text-sm color-text underline font-semibold hover:underline underline-offset-2">{l s='Bénéficier des remises' d='Shop.Theme.Global'}</a>
            </div>
          </div>
          ...
          <div class="flex flex-col h-full">
            <div>
              <h3 class="text-lg font-bold tracking-wide">{l s='Payez en 2x 3x' d='Shop.Theme.Global'}</h3>
            </div>
            <div class="flex-grow">
              <p class="text-sm text-gray-600 font-medium">{l s='Payez en 2 ou 3 fois sans frais avec Alma pour étaler vos paiements en toute simplicité.' d='Shop.Theme.Global'}</p>
            </div>
            <div class="mt-1.5 color-text">
             » <a href="#" class="text-sm color-text underline font-semibold hover:underline underline-offset-2">{l s='En savoir plus' d='Shop.Theme.Global'}</a>
            </div>
          </div>
...
<div class="text-carousel-container w-full flex items-center justify-center absolute left-1/2 transform -translate-x-1/2" id="carousel-trigger">
