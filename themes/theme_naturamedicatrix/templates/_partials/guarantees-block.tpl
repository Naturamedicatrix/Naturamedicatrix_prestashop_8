 ...
 *}
 ...
 <div class="container mx-auto">
   <div class="row flex flex-wrap items-center justify-center guarantee-container">
     <div class="col-lg-3 col-md-3 col-sm-6 col-6 guarantee-item mb-4">
       <div class="flex items-center justify-center mobile-flex">
         ...
         <div class="guarantee-text ml-1">
           <p class="text-sm">Fabrication<br/> européenne</p>
         </div>
       </div>
     </div>
     <div class="col-lg-3 col-md-3 col-sm-6 col-6 guarantee-item mb-4">
       <div class="flex items-center justify-center mobile-flex">
         ...
         <div class="guarantee-text ml-1">
           <p class="text-sm">Respect de<br/> l'environnement</p>
         </div>
       </div>
     </div>
     <div class="col-lg-3 col-md-3 col-sm-6 col-6 guarantee-item mb-4">
       <div class="flex items-center justify-center mobile-flex">
         ...
         <div class="guarantee-text ml-1">
           <p class="text-sm">Satisfaction de<br/> notre clientèle</p>
         </div>
       </div>
     </div>
     <div class="col-lg-3 col-md-3 col-sm-6 col-6 guarantee-item mb-4">
       <div class="flex items-center justify-center mobile-flex">
         ...
         <div class="guarantee-text ml-1">
           <p class="text-sm">Conseils spécialisés<br/> et personnalisés</p>
         </div>
       </div>
     </div>
   </div>
