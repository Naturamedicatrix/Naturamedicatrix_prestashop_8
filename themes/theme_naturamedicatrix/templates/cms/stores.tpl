...
<style>
  ...
  <section id="content" class="page-content page-stores w-full">
    ...
    <div class="col-lg-3 col-md-6 col-xs-12">
  			<div class="mag-item card text-center">
  				<p class="mag-title h4 text-center mt-0">NATURA<em><strong>Medicatrix</strong></em></p>
  				<address class="mag-adresse">
  					26 avenue Emile Digneffe<br/>
      4000 Liège<br/>
      Belgique
  				</address>
			...
			<div class="col-lg-3 col-md-6 col-xs-12">
  			<div class="mag-item card text-center">
  				<p class="mag-title h4 text-center mt-0">Bio-Shanti</p>
  				<address class="mag-adresse">
  					Avenue Adolphe Buyl, 70<br/>
  					1050 Ixelles<br/>
  					Belgique
  				</address>
			...
			<div class="col-lg-3 col-md-6 col-xs-12">
  			<div class="mag-item card text-center">
				<p class="mag-title h4 text-center mt-0">Euro Nutri Santé S.A.</p>
				<address class="mag-adresse">
					14 rue de la Libération<br/>
          L-3510 Dudelange<br/>
          Luxembourg
				</address>
        ...
        <i class="bi bi-telephone"></i> +352&nbsp;26&nbsp;56&nbsp;02&nbsp;36</p>
			...
			<div class="col-lg-3 col-md-6 col-xs-12">
  			<div class="mag-item card text-center">
    			<p class="mag-subtitle small"><span class="badge-pink">Nutrithérapeute Conseil</span></p>
				<p class="mag-title h4 text-center mt-0 mt-12">Le comptoir de la santé</p>
				<address class="mag-adresse">
					153, avenue du Dix Septembre<br/>
