    ...
    <div class="card p-0">
      <div class="pack-product-container">
        <div class="thumb-mask">
          <div class="w-20 h-20">
            <a href="{$product.url}" title="{$product.name}">
              {if !empty($product.default_image.bySize.cart_default)}
                <picture>
                  {if !empty($product.default_image.bySize.cart_default.sources.avif)}
                    <source srcset="{$product.default_image.bySize.cart_default.sources.avif}" type="image/avif">
                  {/if}
                  {if !empty($product.default_image.bySize.cart_default.sources.webp)}
                    <source srcset="{$product.default_image.bySize.cart_default.sources.webp}" type="image/webp">
                  {/if}
                  <img
        ...
        <div class="pack-product-name">
          <a href="{$product.url}" title="{$product.name}" class="color-title no-underline hover:underline">
            {$product.name}
          </a>
        </div>
