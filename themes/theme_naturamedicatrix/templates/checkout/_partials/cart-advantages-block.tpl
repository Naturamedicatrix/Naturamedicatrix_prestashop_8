...
<hr />
  ...
  {* N'afficher le bloc que si le total est d'au moins 20€ *}
  {if $totalText >= 20}
  <div class="shipping-progress-block mt-2 mb-2">
    ...
    {elseif $totalText < $homeThreshold}
      ...
      <p class="text-normal font-bold mb-4">Bravo, livraison offerte en Point Relais !</p>
    ...
    {else}
      <p class="text-normal font-bold mb-0">Bravo, livraison offerte en Point Relais ou à domicile</p>
    {/if}
  </div>
