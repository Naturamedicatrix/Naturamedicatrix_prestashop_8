                        ...
                        <div class="col-sm-9 col-xs-12">
                          <div class="row carrier{if $carrier.logo} carrier-hasLogo{/if}">
                            ...
                            <div class="col-xs-12 carriere-name-container{if $carrier.logo} col-md-8{/if}">
                              ...
                              <span class="carrier-delay"><small>{$carrier.delay}</small></span>
                            </div>
...
*}
  ...
  <div class="alert alert-info visible-desktop-only" id="order-carrier-text">
    <i class="fas fa-info-circle"></i>
    <p>Au moment de la livraison, <strong>nous vous recommandons vivement de vérifier attentivement votre colis et d’en vérifier le contenu</strong> en présence du livreur avant de signer le bordereau de livraison, votre signature vaut décharge&nbsp;!</p>
    <p>Toute réclamation concernant le nombre, le contenu et l’état des colis doit être notifiée de façon claire et précise au transporteur lui-même et écrite sur le bordereau de livraison que vous devrez signer. Vous devrez également nous en informer dans les 24 heures suivant la réception du colis, par envoi d’un courrier électronique au <a href="mailto:logistique@naturamedicatrix.zendesk.com">service client</a>, en précisant vos coordonnées, votre n° de facture, les références du ou des produits figurant sur la facture et en précisant les motifs de votre réclamation.</p>
    <div class="livraison-illustration visible-desktop-only">
      <hr>
      <img class="img-responsive lazy" data-src="https://www.naturamedicatrix.fr/img/livraison-illustration.jpg" alt="Une réception colis efficace en 3 étapes" src="https://www.naturamedicatrix.fr/img/livraison-illustration.jpg">
    </div>
  </div>
