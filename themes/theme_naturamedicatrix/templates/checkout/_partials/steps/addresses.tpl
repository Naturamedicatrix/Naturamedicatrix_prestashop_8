  ...
  <div class="js-address-form">
    ...
    >
      ...
      {elseif $customer.addresses|count > 0}
        ...
        <p class="add-address">
          <a href="{$new_address_delivery_url}" class="btn btn-secondary"><i class="material-icons">&#xE145;</i>{l s='add new address' d='Shop.Theme.Actions'}</a>
        </p>
      ...
      {if !$use_same_address}
        ...
        {else}
          ...
          <p class="add-address">
            <a href="{$new_address_invoice_url}" class="btn btn-secondary"><i class="material-icons">&#xE145;</i>{l s='add new address' d='Shop.Theme.Actions'}</a>
          </p>
        {/if}
