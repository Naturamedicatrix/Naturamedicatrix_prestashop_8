...
{block name='step_content'}
  <div class="js-address-form">
    ...
    >
      ...
      {else}
        <h2 class="h4"><i class="bi bi-house"></i> {l s='Shipping Address' d='Shop.Theme.Checkout'}</h2>
      {/if}
      ...
      {elseif $customer.addresses|count > 0}
        ...
        <p class="add-address">
          <a href="{$new_address_delivery_url}" class="btn-small btn-secondary"><i class="material-icons">&#xE145;</i>{l s='add new address' d='Shop.Theme.Actions'}</a>
        </p>
      ...
      {if !$use_same_address}
        ...
        <h2 class="h4"><i class="bi bi-file-text"></i> {l s='Your Invoice Address' d='Shop.Theme.Checkout'}</h2>
        ...
        {else}
          ...
          <p class="add-address">
            <a href="{$new_address_invoice_url}" class="btn-small btn-secondary"><i class="material-icons">&#xE145;</i>{l s='add new address' d='Shop.Theme.Actions'}</a>
          </p>
        {/if}
