  ...
  <section id="main">
    ...
    {block name='page_header_container'}
      <header class="page-header">
        ...
        <div class="logo">{* <img src="{$shop.logo}" alt="logo" loading="lazy"> *} <img src="{$urls.child_img_url}logo-naturamedicatrix.svg" alt="NATURAMedicatrix" loading="lazy" class="h-8" /></div>
        {/block}
