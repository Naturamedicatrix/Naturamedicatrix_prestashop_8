  ...
  <div class="page_content">
    <div class="col-xs-12 psgdprinfo17 p-0">
      ...
      <div class="data-export-buttons">
        <a id="exportDataToCsv" class="btn btn-outline psgdprgetdatabtn17 mb-1" target="_blank" href="{$psgdpr_csv_controller|escape:'htmlall':'UTF-8'}">{l s='OBTENIR MES DONNÉES EN CSV' mod='psgdpr'}</a>
        <a id="exportDataToPdf" class="btn btn-outline psgdprgetdatabtn17" target="_blank" href="{$psgdpr_pdf_controller|escape:'htmlall':'UTF-8'}">{l s='OBTENIR MES DONNÉES EN PDF' mod='psgdpr'}</a>
      </div>
    </div>
