      ...
      <section class="form-fields w-full">
        ...
        <div class="flex flex-col mb-6 mt-4">
          ...
          <div class="js-input-column">
            <select name="id_contact" id="id_contact" class="w-100 sm:w-full border border-gray-300 rounded-md px-4 text-base focus:outline-none focus:ring-primary focus:border-black bg-white">
        ...
        {if $contact.orders}
          <div class="flex flex-col mb-6 mt-4">
            <label class="text-left font-bold text-base required after:ml-0.5 after:text-red-500" for="id_order">{l s='Référence commande' d='Modules.Contactform.Shop'}<span class="text-gray-700 font-normal ml-1.5 text-sm">({l s='optionnel' d='Modules.Contactform.Shop'})</span></label>
            <div class="js-input-column">
