{**
 * Template personnalisé pour le module ps_bestsellers
 * Affiche des produits spécifiques au lieu des meilleures ventes réelles
 *}
<section class="featured-products clearfix">
  <h2 class="h2 products-section-title">
    {l s='Deal of the day' d='Shop.Theme.Catalog'}
  </h2>
