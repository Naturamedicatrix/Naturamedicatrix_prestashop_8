 ...
 *}
    ...
    {if empty($has_notification)}
        ...
        <button
            ...
            class="btn btn-primary js-mailalert-add mt-0"
            rel="nofollow">
            <i class="bi bi-bell-fill"></i> {l s='Notify me' d='Modules.Emailalerts.Shop'}
        </button>
        <p><small>{l s='You will be notified when this product is available.' d='Modules.Emailalerts.Shop'}</small></p>
        <div class="js-mailalert-alerts"></div>
    {else}
        <article class="alert alert-info" role="alert">{l s='You will be notified when this product is available.' d='Modules.Emailalerts.Shop'}</article>
    {/if}
    </div>
